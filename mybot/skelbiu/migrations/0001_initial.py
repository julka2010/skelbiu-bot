# Generated by Django 2.0.1 on 2018-01-17 12:02
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('price', djmoney.models.fields.MoneyField(decimal_places=2, default=Decimal('0.0'), default_currency='EUR', max_digits=8)),
                ('action', models.CharField(choices=[('propose', 'Siūlau'), ('looking', 'Ieškau')], default='propose', max_length=8)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('advertisement', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='images', to='skelbiu.Advertisement')),
            ],
        ),
        migrations.CreateModel(
            name='PhoneModel',
        ...
        migrations.AddField(
            ...
            name='phone',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='skelbiu.PhoneModel'),
        ),
    ]
